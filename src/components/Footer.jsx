      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/search/babysitter" className="hover:text-primary transition">
                  {t('footer.forFamilies')}
                </a>
              </li>
              <li>
                <a href="/search/family" className="hover:text-primary transition">
                  {t('footer.forBabysitters')}
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/search/babysitter" className="hover:text-primary transition">
                  {t('footer.findBabysitter')}
                </a>
              </li>
              <li>
                <a href="/search/family" className="hover:text-primary transition">
                  {t('footer.becomeBabysitter')}
                </a>
              </li>
            </ul>
          </div>
          ...
          {/* Ressources */}
          <div>
            <h3 className="text-white font-semibold mb-4">{t('footer.resourcesTitle')}</h3>
            <ul className="space-y-2 text-sm">
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/quality-charter" className="hover:text-primary transition">
                  {t('footer.qualityCharter')}
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="max-w-md mx-auto text-center">
            <h3 className="text-white font-semibold mb-2">{t('footer.newsletter')}</h3>
            ...
            <div className="flex gap-2">
              ...
              />
              <button className="px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition flex items-center gap-2">
                <Send size={18} />
                {t('footer.subscribe')}
              </button>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-500">
          <p>© 2025 SkyNanny. {t('footer.rights')}</p>
        </div>
      </div>
    </footer>
  );
